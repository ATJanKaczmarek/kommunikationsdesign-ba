...
Loos uns Sullivan hatten Gemeinsamkeiten, jedoch auch extreme Unterschiede. Es würde den Rahmen sprengen noch detaillierter auf die beiden Architekten einzugehen. Festzuhalten ist, dass sowohl Sullivan als auch Loos prägend waren und bis heute Teil der Lehre sind. Beide waren prägend für die Moderne Architektur und das etablieren eines Stils. Sullivan und Loos verfassten Texte, die ihre Überzeugungen transportierten, dabei sind deutliche Unterschiede feststellbar. \citeauthor{mossConstructingModernVienna2010} erwähnt einen Brief von Sullivan an Loos, in welchem er Loos als \enquote{brother in spirit} bzeichnet \autocite[11]{mossConstructingModernVienna2010}. 
Der wichtigste Unterschied zwischen Sullivan und Loos bezieht sich auf das Ornament. Während Loos Ornament geradezu verteufelte und strikt ablehnte wandte Sullivan Ornament in seinen Gebäuden an. Sullivan beschreibt Ornament als Chance eines Ausdrucks von Emotion und Individualität eines Gebäudes. Gute Architektur beschreibt er als Kunst. Grundlegend ist dafür jedoch seine Feststellung, dass das Ornament aus der Natur eines Gebäudes enstehen muss \autocite{sullivanOrnamentInArchitec}. Damit bleibt Sullivan strikt bei seinem \enquote{form follows function}.
Weiter schlägt Sullivan vor, dass man für 

Abschließend kann zu Loos und zu Sullivan festgestellt werden, dass sich beide einig darüber waren, dass der überbordende, oppulete Einsatz von Ornament, das reine Überpinseln und Verzieren von Gebäuden nicht im Sinne der Architektur standen. Loos und Sullivan betrateten beide die Architektur als eine Form von Kunst. Aus heutiger Sicht betrachtet, waren die beiden Designer, die Gebäude so gestalteten, dass Sie einen Zweck erfüllten. Sullivan verzichtete dabei nicht auf Ornament und auch Loos tat dies nicht. Stattdessen ging es Loos darum den Begriff des Ornaments nicht zu verwenden, denn in Ornament steckte für ihn Zwecklosigkeit und Ineffizienz. Ohne es Ornament zu nennen setzte Loos Akzente, die durchaus als Dekoration verstanden werden können. Beispielsweise das Looshaus am Michaelerplatz 3 in Wien. Adolf Loos verwendet für die Gebäudefassade im unteren Bereich grünen Marmor, der sich von der weißen Fassade im oberen Teil abgrenzt. Nun kann der grüne Marmor als Ornament interpretiert werden und damit bricht Loos mit seinen Vorstellungen, oder aber man versteht den Marmor nicht als Ornament, sondern sieht den Zweck des edlen Materials. Das Gebäude war ursprünglich so konzipiert, dass sich der obere Teil mit weißer Fassade vom unteren Teil (Ladengeschäft) absetzt. Der Marmor wirkt edel, erregt Aufmerksamkeit und lädt Kundschaft ein wohingegen, die Wohnungen kein Aufsehen der Öffenlichkeit erregen sollen, sie sollen kein Hingucker sein. Sie dienen als privater Rückzugsort.
